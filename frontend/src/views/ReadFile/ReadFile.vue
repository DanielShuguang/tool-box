  ...
  <div class="flex flex-col size-full">
    ...
    <n-form label-placement="left">
      ...
      <n-form-item label="同时下载任务数">
        <n-input-number v-model:value="maxDownloadCount" :min="1" :disabled="isDownloading" />
      </n-form-item>
      <n-form-item label="单个任务的下载线程数">
        <n-input-number v-model:value="concurrentCount" :min="1" :disabled="isDownloading" />
    ...
    <div
      ref="outputRef"
      class="relative flex-1 bg-[#fff] border border-[#ddd] border-solid p-[10px] overflow-auto"
    >
      <n-button
